		...
		<div style="width: 900px; margin: 52px auto;">
			...
			<div style="float: right;">
				 <div class="notificationbox">
				 	</a><a href="notifications.php"><h2 style="float: left; color: #848684;"> Notification&nbsp;</h2></a><a href="notification.php"><h2  style="float: left; color: #0B810B;">|&nbsp;Post Notification</h2>
