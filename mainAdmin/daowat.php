...
<div class="main">
	...
	<table class="adminmenu">
		<tr>
			...
			<th style="background-color: #686B68;"><a href="daowat.php" ><h1>Daowat</h1></a></th>
	...
	<table class="rightsidemenu">
		...
		<tr>
			...
			$query = "SELECT * FROM daowat ORDER BY id DESC LIMIT 15";
			...
			<th class="editpost"><a href="viewdaowatPost.php?dpst=<?php echo $id; ?>">View</a></th>
		</tr>
		<?php } ?>
	</table>
</div>
